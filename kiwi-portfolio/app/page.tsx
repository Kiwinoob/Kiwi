  ...
  return (
    <div className="min-h-screen flex items-center px-4 sm:px-8 xl:px-32 2xl:px-64 relative overflow-hidden">
      ...
      >
        ...
        >
          Hey there, I'm <span className="text-cyber-light block mt-2">Kee Hui</span>
        </motion.h1>
        <motion.p
        ...
        >
          A passionate Web Developer and open-source advocate. Currently focused on creating secure and scalable web
